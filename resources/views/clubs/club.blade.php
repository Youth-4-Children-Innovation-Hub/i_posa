    ...
    <div class="modal fade" id="CreateModal" tabindex="-1">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form method="POST" action="{{ route('create_club') }}">
                    @csrf
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-3" id="input-container">
                                    ...
                                    <div class="col-sm-10 input-group">
                                        <input type="text" class="form-control" name="multiInput[]" id="name" required>
                                        <div class="input-group-append">
                                            <button class="btn btn-outline-secondary" type="button" onclick="addInputField()">Add</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-3">
